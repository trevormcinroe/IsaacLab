...
It renames all the occurrences of multimodal_gym (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        # rename the multimodal_gym folder
        os.rename(
            os.path.join(root_dir_path, "exts", "multimodal_gym", "multimodal_gym"),
            os.path.join(root_dir_path, "exts", "multimodal_gym", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "multimodal_gym"), os.path.join(root_dir_path, "exts", new_name))
