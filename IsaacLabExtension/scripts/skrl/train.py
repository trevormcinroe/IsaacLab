...
if args_cli.ml_framework.startswith("torch"):
    ...
    from multimodal_gym.utils.skrl.memories import RandomMemory
...
def main(env_cfg, agent_cfg: dict):
    ...
    for step in range(100_000_000 // (args_cli.timesteps * args_cli.num_envs)):
        # Eval routine
        if args_cli.record:
        ...
        eval_returns['reach_success'] = eval_returns['reach_success'] > 1.0
