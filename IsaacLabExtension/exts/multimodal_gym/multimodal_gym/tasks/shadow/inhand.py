...
from multimodal_gym.tasks.shadow.shadow_hand_env_cfg import ShadowHandEnvCfg
...
class InHandManipulationEnv(DirectRLEnv):
    ...
    def get_num_observations(self):
        ...
        match self.cfg.obs_type:
            case "full":
                return self.cfg.num_observations
            case "image":
    ...
    def _get_images(self):
        ...
        if self.cfg.write_image_to_file:
            ...
            img_dir = "/home/elle/code/external/IsaacLab/IsaacLabExtension/images/shadow" 
