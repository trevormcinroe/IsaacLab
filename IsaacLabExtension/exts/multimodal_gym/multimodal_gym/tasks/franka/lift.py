...
class LiftEnvCfg(DirectRLEnvCfg):
    ...
    tiled_camera: TiledCameraCfg = TiledCameraCfg(
        ...
        offset=TiledCameraCfg.OffsetCfg(pos=(1.0, -2.0, 0.0), rot=(1,0,0,0), convention="world"),
        data_types=["rgb"],
        spawn=sim_utils.PinholeCameraCfg(
            focal_length=5.0, focus_distance=400.0, horizontal_aperture=20.955, clipping_range=(0.01, 20.0)
        ),
        width=512,
        height=512,
        #debug_vis=True
