...
class LiftEnvCfg(DirectRLEnvCfg):
    ...
    tiled_camera: TiledCameraCfg = TiledCameraCfg(
        ...
        offset=TiledCameraCfg.OffsetCfg(pos=(0.85, -1.10, 0.9), rot=(1,0,1,1), convention="world"),
        data_types=["rgb"],
        spawn=sim_utils.PinholeCameraCfg(
            focal_length=34.0, focus_distance=400.0, horizontal_aperture=20.955, clipping_range=(0.01, 200.0)
        ),
        width=512,
        height=512,
        #debug_vis=True
